...
import Coupon from "../imgs/coupon4.jpg";
...
function Page4() {
  ...
  useEffect(() => {
    const auth = localStorage.getItem("answered4");
  ...
  const handleAnswer = () => {
    if (answer2 !== "" && answer1 !== "") {
      ...
      setTimeout(() => {
        setOpened(false);
        if (
          answer1.replace(/[^A-Z0-9]/gi, "").toLocaleLowerCase() === "purple" &&
          answer2.replace(/[^A-Z0-9]/gi, "").toLocaleLowerCase() === "purple"
        ) {
          setBonus({ won: "50%", correct: 2 });
          handleOpen();
        } else if (
          (answer1.replace(/[^A-Z0-9]/gi, "").toLocaleLowerCase() ===
            "purple" &&
        ...
        {!userAnswered ? (
          <div>
            <Paper elevation={8} className="box">
              <Typography>Product ID: 714371</Typography>
              <br />
              <img
                src={Coupon}
                style={{
            ...
            {!start && (
              <Fab
                ...
                onClick={() => {
                  setStart(true);
                  localStorage.setItem("answered4", true);
                }}
              >
                Your question
              </Fab>
                  ...
                  >
                    <TabPanel value={value} index={0} dir={theme.direction}>
                      <Typography variant="body2">
                        When two colors "red" and "blue" are mixed together, the
                        resultant color is?
                      </Typography>
                      <Box sx={{ m: 2 }}>
                        <Stack
